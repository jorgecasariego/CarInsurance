...
public class LoginInteractor {
    ...
    /**
     * Para evitar comprobar con cada estado, usa isUserResolvableError() para agrupar aquellos
     * códigos que permiten que el usuario arregle el inconveniente. Si no es así entonces reporta
     * con Callback.onGooglePlayServicesFailed().
     *
     * @param callback
     * @return
     */
    ...
    private void signInUser(String email, String password, final Callback callback) {
        mFirebaseAuth.signInWithEmailAndPassword(email, password)
                // Para saber en qué momento termina la operación, debemos añadir una escucha
                // OnCompleteListener con el método addOnCompleteListener().
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {

                    // Task representa una operación asíncrona en Google Apis y
                    // AuthResult contiene los datos del usuario si la autenticación fue un éxito.
                    @Override
